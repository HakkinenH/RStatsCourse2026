...
plot(glmPdace)
#looks bad, especially that fourth plot
...
#we will cover AIC later in the workshop, but as a quick summary: it compares models and establishes which explains the data better
