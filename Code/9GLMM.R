...
ggplot(clutch, aes(date, CLUTCH, col=strtno)) + geom_point() +
  geom_line(data=newdata_t, aes(date, py, group=strtno), lty = 2, col = "blue", linewidth=0.9) +
  geom_line(data=newdata_f, aes(date, py, group=strtno), lty = 2, col = "green4", linewidth=0.9) +
...
ggplot(clutch, aes(date, CLUTCH, col=strtno)) + geom_point() +
  geom_line(data=newdata_tm, aes(date, meanClutch), lty = 1, col = "red", linewidth=1) +
  geom_line(data=newdata_tm, aes(date, meanClutch+sdClutch), lty = 2, col = "red", linewidth=1) +
  geom_line(data=newdata_tm, aes(date, meanClutch-sdClutch), lty = 2, col = "red", linewidth=1) +
  geom_line(data=newdata_fm, aes(date, meanClutch), lty = 1, col = "blue", linewidth=1) +
  geom_line(data=newdata_fm, aes(date, meanClutch+sdClutch), lty = 2, col = "blue", linewidth=1) +
  geom_line(data=newdata_fm, aes(date, meanClutch-sdClutch), lty = 2, col = "blue", linewidth=1) +
  xlab("date") + ylab("Clutch Size")
...
##TASK: build a GLMM to investigate this dataset, 
